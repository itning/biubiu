...
<link rel="stylesheet" type="text/css" href="/sys/frontendStyle/css/index_1.css" />
	...
	* {
	...
	#dish_2 li{
		background:url(/sys/frontendStyle/images/img/btn.png);
		width:164px;
		height:47px;
		text-align:center;
		padding-top:5px;
...
<body style="text-align: center">
	...
	<div class="index_all" style="text-align:center;">
		<!--上面的背景层-->
		<div>
			<img src="/sys/frontendStyle/images/flower.gif" />
		</div>
		<!--中间层-->
		<div id="index_center">
			<!--中间层的空白层-->
			...
			<div>
				...
				<div class="bg_middle">
					<img
						src="/sys/frontendStyle/images/index_menu.gif"
						border="0" usemap="#Map" />
					<map name="Map" id="Map">
				...
				<ul style=" display:inline-table">
					<c:forEach items="${list}" var="board">
						<c:if test="${board.tableStatus==0}">
							<li>
								<a href="/CaidanServlet?id=${board.id}">
									${board.tableName}&nbsp;
								</a>
							</li>
						</c:if>
