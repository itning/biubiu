...
<div id="TitleArea">
    ...
    <div id="TitleArea_Title">
        <div id="TitleArea_Title_Content">
            <img border="0" width="13" height="13" src="/sys/style/images/title_arrow.gif"/> 更新菜系
        </div>
    </div>
...
<div id="MainArea">
    ...
    <form action="updateServlet" method="post">
        ...
        <div class="ItemBlock_Title">
            <img width="4" height="7" border="0" src="/sys/style/images/item_point.gif"> 菜系信息&nbsp;
        </div>
        <!-- 本段表单字段 -->
                ...
                <div class="ItemBlock2">
                    <table cellpadding="0" cellspacing="0" class="mainForm">
                        <tr>
                            ...
                            <td>
                                <input type="text" name="name" class="InputStyle" value="${foodType.typeName}"/> *
                                <input type="hidden" name="cid" value="${foodType.id}"/>
                            </td>
                        </tr>
                    </table>
                </div>
