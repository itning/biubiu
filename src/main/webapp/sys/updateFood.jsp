...
<div id="TitleArea">
    ...
    <div id="TitleArea_Title">
        <div id="TitleArea_Title_Content">
            ...
            <img border="0" width="13" height="13" src="/sys/style/images/title_arrow.gif"/> 更新新菜品
...
<div id="MainArea">
    <!-- 表单内容 -->
    <form action="/updataFood" method="post">
        <!-- 本段标题（分段标题） -->
        <div class="ItemBlock_Title">
            <img width="4" height="7" border="0" src="/sys/style/images/item_point.gif"> 菜品信息&nbsp;
        </div>
        <!-- 本段表单字段 -->
                        ...
                        <tr>
                            ...
                            <td>
                                <select name="cid" style="width:80px">
                                    ...
                                    <c:forEach items="${list}" var="foodType">
                                        <option value="${foodType.id}"
                                        >${foodType.typeName}</option>
                                    </c:forEach>
                                </select>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <img style='max-width:68px;width:68px;width:expression(width>68?"68px":width "px");max-width: 68px;'
                                     src="${food.img}">
                                <input type="file" name="imageUrl" value="${food.img}"/> *
                            </td>
                        </tr>
                    </table>
                </div>
