		...
		<div id="TitleArea_Title">
			<div id="TitleArea_Title_Content">
				<img border="0" width="13" height="13"
					src="/sys/style/images/title_arrow.gif" /> 菜系列表
			</div>
		</div>
	...
	<div id="MainArea">
		<table class="MainArea_Content" align="center" cellspacing="0" cellpadding="0">
			...
			<c:forEach items="${list}" var="foodType">
				<tr>
					...
					<td>
						<a href="/updateCuisineServlet?id=${foodType.id}" class="FunctionButton">更新</a>
						<a href="/deletCuisineListServlet?id=${foodType.id}" class="FunctionButton">删除</a>
					</td>
				</tr>
			</c:forEach>
		...
		<div id="TableTail" align="center">
			<div class="FunctionButton">
				<a href="/sys/saveCuisine.jsp">添加</a>
			</div>
		</div>
	</div>
</body>
