...
<head>
    ...
    <style type="text/css">
        ...
        #Menu .level1 .MenuLevel2 .level2Style {
            ...
            padding-top: 5px;
            width: 112px;
            background-image: url("/sys/style/images/img/menu_arrow_single.gif");
...
<ul id="Menu">
    <li class="level1">
        <div onClick="menuClick(this);" class="level1Style">
            <img src="/sys/style/images/func20001.gif" class="Icon"/>
            系统菜单
        </div>
        <ul class="MenuLevel2">
            ...
            <li class="level2 level2Style">
                <a target="right" href="/foodServlet">菜品管理</a>
            </li>
            <li class="level2 level2Style">
                <a target="right" href="/sys/orderList.html">餐厅订单</a>
            </li>
        </ul>
    </li>
</ul>
